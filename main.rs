...
/**
    This function is responsible for printing the packet info to the GUI. The final_string
    is sent to GUI console for printing. This function uses all the above functions.
*/
fn printPacketInfo(packet: &pcap::Packet)
{
    if packet.data[23] == 6
    {
        ...
        println!("{}", final_string); //TODO We can send this string to the GUI
    }
